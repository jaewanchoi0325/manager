...
const routes: Routes = [
  ...
  },
  {
    path: "signup1",
    loadChildren: () =>
      import("./signup/signup1/signup1.module").then(m => m.Signup1PageModule)
  },
  {
    path: "signup2",
    loadChildren: () =>
      import("./signup/signup2/signup2.module").then(m => m.Signup2PageModule)
  },
  {
    path: "signup3",
    loadChildren: () =>
      import("./signup/signup3/signup3.module").then(m => m.Signup3PageModule)
  },
  {
    path: "login1",
    loadChildren: () =>
  ...
  },
  {
    path: "parking",
    loadChildren: () =>
      import("./renter/parking/parking.module").then(m => m.ParkingPageModule)
  },
  {
  ...
  {
    path: 'owneropinion',
    loadChildren: () => import('./owner/owneropinion/owneropinion.module').then( m => m.OwneropinionPageModule)
  },
  {
    path: 'owneropiniondetail',
    loadChildren: () => import('./owner/owneropiniondetail/owneropiniondetail.module').then( m => m.OwneropiniondetailPageModule)
  }
];
